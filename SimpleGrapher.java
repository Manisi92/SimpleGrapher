...
public class SimpleGrapher extends Application {
	...
	public void start(Stage stage) {
		...
		graphIt.setOnAction(evt -> {
			// Get the user's functio definition from the box and use it
		...
		message.setTextFill(Color.RED); //Red text for message.
		message.setStyle("-fx-background-color:white; -fx-padding:7px; " + "-fx-border-color: gray; -fx-border-width:0 0 4px 0");
		...
		/* Finish setting up the windows and make it visible. */
